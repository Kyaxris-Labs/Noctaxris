...
func (s *Server) serveHTTP(w http.ResponseWriter, r *http.Request) {
	...
	case catalog.ActionSFNCreateStateMachine, "CreateStateMachine",
		...
		catalog.ActionSFNSendTaskSuccess, "SendTaskSuccess",
		catalog.ActionSFNSendTaskFailure, "SendTaskFailure",
		catalog.ActionSFNSendTaskHeartbeat, "SendTaskHeartbeat",
	...
	case catalog.ActionCognitoCreateUserPool, "CreateUserPool",
		...
		catalog.ActionCognitoAdminGetUser, "AdminGetUser",
		catalog.ActionCognitoAdminSetUserPassword, "AdminSetUserPassword",
		catalog.ActionCognitoAdminDeleteUser, "AdminDeleteUser",
		catalog.ActionCognitoAdminDisableUser, "AdminDisableUser",
		catalog.ActionCognitoListUsers,

...
- ActiveMQ JMS client, multi-destination ESM, durable subscriptions, and OpenWire/STOMP ESM paths (out of lab scope; AMQP 1.0 receive on `queue://noctaxris` is shipped when the nested broker is `RUNNING`)

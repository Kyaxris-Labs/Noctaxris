...
- Kinesis Enhanced Fan-Out (`RegisterStreamConsumer` / `SubscribeToShard`) / `ParallelizationFactor`, MQ ESM sources (out of lab scope; sequential multi-shard ESM is the lab path)

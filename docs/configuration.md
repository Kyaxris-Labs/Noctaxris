...
Expect liveness body `ok`, readiness body `ready`, and version body matching `VERSION` (e.g. `1.1.0`). Distroless probes use `/noctaxris healthcheck` inside the API container.

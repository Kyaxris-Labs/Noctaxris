...
<table>
  ...
  <tbody>
    ...
    <tr>
      ...
      <td>Fleet indexing, operator BYO CA APIs, retained MQTT store (empty 200 list), WAN ATS hostnames.</td>
    </tr>
    <tr>
...
| [docs/release.md](docs/release.md) | Cutting a release (`v1.4.1`, Hub `latest` / semver) |
